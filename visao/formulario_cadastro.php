<div class="form-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="titulo" type="text" name="titulo" value="" required="" />
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="categoria" type="text" name="categoria" value=""  />
        </div>
    </div>
    <div class="control-group">
        <div class="controls">
            <input type="submit" class="span2 btn btn-success" value="Gravar" />
        </div>
    </div>
</div>